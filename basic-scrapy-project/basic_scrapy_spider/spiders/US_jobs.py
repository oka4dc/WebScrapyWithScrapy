...
class LinkedJobsSpider(scrapy.Spider):
    # Linkedin_US
    name = "linkedin_jobs_US"
    api_url = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=Artificial%2BIntelligence%2BEngineer&location=United%2BStates&geoId=103644278&trk=public_jobs_jobs-search-bar_search-submit&start=25' 
