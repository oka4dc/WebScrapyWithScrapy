...
class LinkedJobsSpider(scrapy.Spider):
    """ Linkedin_canada """
    name = "linkedin_jobs_canada"
    api_url = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=AI%2BEngineer&location=canada&geoId=&trk=public_jobs_jobs-search-bar_search-submit&start=25' 
