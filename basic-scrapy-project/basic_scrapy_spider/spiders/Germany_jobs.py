...
class LinkedJobsSpider(scrapy.Spider):
    # Linkedin_Germany
    name = "linkedin_jobs_germany"
    #api_url = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=AI%2BEngineer&location=germany&geoId=&trk=public_jobs_jobs-search-bar_search-submit&start=50' 
     
    api_url = 'https://www.linkedin.com/jobs-guest/jobs/api/seeMoreJobPostings/search?keywords=AI%2BEngineer&location=Stadt%2BBerlin%2C%2BBerlin%2C%2BGermany&geoId=101283667&trk=public_jobs_jobs-search-bar_search-submit&start=25'
